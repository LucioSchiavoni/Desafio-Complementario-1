...
function BuscarAlfajor(alfajores){
    ...
    let AlfajorBuscado = alfajores.find(alfajor => alfajor.nombre == NombreAlfajor)
...
function PrecioAlfajor(alfajores){
    ...
    let EncontrarPrecio = alfajores.filter(alfajores => alfajores.precio >= BuscarPrecio)
...
function OrdenarPrecios(alfajores){
    let Ordenar = parseInt(prompt("Ingrese 1 para ordenar de menor a mayor precio, 2 para ordenar de mayor a menor precio"))
